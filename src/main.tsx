...
type Support = { id: string; name: string; type: string; size: number; importedAt: string; category?: string; blob?: Blob; dataUrl?: string; extraction?: Extraction; pdfProgress?: PdfProgress; pdfBookmarks?: number[]; pdfNotes?: PdfPageNote[] };
